        ...
        <div class="banner gradient-bg">
            <div class="container">
                <div class="row cnt-block">
                    <div class="col-md-7">
                        <div class="left">
                            <h1>Easy Customizable Ipsum and WebApp Template</h1>
                            <p>Developed for Ipsum and Web Applications!</p>
                        </div>
                    </div>
                    <div class="col-md-4 right-sec"> <a href="#" class="get-started">Purchase Now</a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pop-box clearfix">
                            ...
                            <div class="right-cnt">
                                <h3>Manage your SEO Accounts</h3>
                                <p>Lorem Ipsum is simply dummy text of the printing</p>
                            </div>
                        </div>
                        ...
                        <div class="pop-box right clearfix">
                            ...
                            <div class="right-cnt">
                                <h3>Get Live Online SEO Report</h3>
                                <p>Lorem Ipsum is simply dummy text of the printing</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <div class="head-block">
                            <h2>Audience First Content <span>Marketing</span></h2>
